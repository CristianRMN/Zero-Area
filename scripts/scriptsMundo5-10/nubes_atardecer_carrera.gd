...
var limit_screen = 8433  # Límite de la pantalla para mover el viento hacia la derecha
var start_position = Vector2(-1081, -525)  # Posición inicial del viento fuera de la pantalla
